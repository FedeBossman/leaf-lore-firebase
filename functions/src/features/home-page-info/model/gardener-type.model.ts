...
export const gardenerTypes: GardenerType[] = [
  ...
  {
    name: GardenerTypes.indoorGardener,
    description: "Prefers growing plants indoors, often in containers or indoor beds, including houseplants and indoor herbs."
  },
  {
    name: GardenerTypes.communityGardener,
    description: "Participates in communal garden spaces, often with a focus on community engagement and local food production."
  },
  {
    name: GardenerTypes.landscapeGardener,
    description: "Focuses on designing, creating, and maintaining outdoor spaces, often blending aesthetics with functionality."
  },
  {
    name: GardenerTypes.therapeuticGardener,
    description: "Uses gardening as a form of therapy, focusing on the psychological and physical benefits of gardening."
  },
